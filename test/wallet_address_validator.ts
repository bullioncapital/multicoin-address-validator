...
function valid(
  ...
  const valid = validate(address, currency, opts);
...
describe("WAValidator.validate()", () => {
  describe("valid results", () => {
    ...
    it("should return true for correct Arbitrum addresses", () => {
      ...
      valid("0xD1220A0cf47c7B9Be7A2E6BA89F429762e7b9aDb", "UNKNOWN token", {
        chainType: "arbitrum",
      });
    });
    ...
    it("should verify SPL addresses", () => {
      ...
      valid("69UwBV4LPg7hHUS5JXiXyfgVnESmDKe8KJppsLj8pRU", "usdt", {
        chainType: "solana",
        networkType: "prod",
      });
    ...
    it("should verify SPL addresses for unknown tokens", () => {
      ...
      valid("69UwBV4LPg7hHUS5JXiXyfgVnESmDKe8KJppsLj8pRU", "neon", {
        chainType: "solana",
        networkType: "prod",
      });
      invalid("0x9ec7d40d627ec59981446a6e5acb33d51afcaf8a", "shdw", {
        chainType: "solana",
        networkType: "prod",
      });
    });
  ...
  describe("invalid results", () => {
    ...
    it("should return false for incorrect solana addresses for unknown tokens, even if chainType is provided", () => {
      ...
      invalid("833XorXTTx5iya5B3Tr6iqEs9GbRuvVfwyLCP2vpdz", "mobile", {
        chainType: "solana",
      });
      invalid(
        "bc1qwqdg6squsna38e46795at95yu9atm8azzmyvckulcc7kytlcckxswvvzej",
      ...
      invalid(
        "addr1skemppmfevyk0lshu2w8j34707s3t3t58a04xcx5ccevrcmvpmxg2qt4pk0",
        "mobile",
        { chainType: "solana", networkType: "testnet" },
      );
    });
